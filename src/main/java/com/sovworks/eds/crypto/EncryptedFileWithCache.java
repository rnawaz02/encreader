...
public class EncryptedFileWithCache extends EncryptedFile
{
			...
			throws FileNotFoundException
	{
		...
		_cache = new HashMap<Integer, CachedSectorInfo>(_maxNumberCachedBuffers);
	}
	...
	public synchronized void close(boolean closeBase) throws IOException
	{
        try
        {
            ...
            {
                CachedSectorInfo ci = _cache.get(i);
	...
	private final HashMap<Integer, CachedSectorInfo> _cache;
