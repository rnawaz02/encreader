...
public class FS extends FileSystemWrapper
{
    ...
    public static byte[] deriveKey(byte[] password, byte[] salt, int numIterations, int keySize, int ivSize) throws EncryptionEngineException, DigestException
    {
